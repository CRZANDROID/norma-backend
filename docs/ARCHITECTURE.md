...
Local: [docker.md](./docker.md). Prod este mes: Web Service y Background Worker, los dos en Render ([render-deploy.md](./render-deploy.md)). El mes que viene el worker pasa a Hetzner ([worker-vps.md](./worker-vps.md)). Picos: [PERFORMANCE.md](./PERFORMANCE.md).
